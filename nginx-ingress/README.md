...
`controller.serviceAccount.imagePullSecrets` | Deprecated and will be removed in KIC v1.10, use `controller.serviceAccount.imagePullSecretName` instead. The names of the secrets containing docker registry credentials. | []
